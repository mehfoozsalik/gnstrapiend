...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    freeTextArea: Schema.Attribute.RichText &
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::about.about'> &
      Schema.Attribute.Private;
    pageImage: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    pageTitle: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    someQuestions: Schema.Attribute.Component<'about.some-questions', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    visionStatement: Schema.Attribute.Component<'about.vision', false>;
    whyUs: Schema.Attribute.Component<'about.why-us', false>;
  };
}
...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    tags: Schema.Attribute.Component<'blog.tags', true>;
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footer: Schema.Attribute.Component<'all.footer', false>;
    header: Schema.Attribute.Component<'all.header', false>;
    herosection: Schema.Attribute.Component<'home.hero-section', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::home.home'> &
      Schema.Attribute.Private;
    promotionalBanner: Schema.Attribute.Component<'promotion.banner', false>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    products: Schema.Attribute.Relation<'manyToMany', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    ShippedAddress: Schema.Attribute.Text;
